...
#define NUM_GROUPS_WESTMEREEX 11

static PerfmonGroupMap westmereEX_group_map[NUM_GROUPS_WESTMEREEX] = {
...
void
perfmon_printDerivedMetricsWestmereEX(PerfmonGroup group)
{
    int threadId;
    ...
    switch ( group ) 
    {
        ...
        case MEM:
            ...
            bstrListAdd(fc,8,Memory BW [MBytes/s]);
        ...
        default:
            fprintf (stderr, "perfmon_printDerivedMetricswestmereEX: Unknown group! Exiting!\n" );
            exit (EXIT_FAILURE);
            break;
    }
...
void
perfmon_logDerivedMetricsWestmereEX(PerfmonGroup group, double time,double timeStamp)
{
    int threadId;
    double tmpValue;
    double inverseClock = 1.0 /(double) timer_getCpuClock();
...
static PerfmonGroupHelp westmereEX_group_help[NUM_GROUPS_WESTMEREEX] = {
