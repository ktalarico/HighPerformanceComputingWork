...
#define NUM_GROUPS_IVYBRIDGE 7

static PerfmonGroupMap ivybridge_group_map[NUM_GROUPS_IVYBRIDGE] = {
...
void
perfmon_printDerivedMetricsIvybridge(PerfmonGroup group)
{
    int threadId;
    ...
    switch ( group ) 
    {
        ...
        default:
            fprintf (stderr, "perfmon_printDerivedMetricsivybridge: Unknown group! Exiting!\n" );
            exit (EXIT_FAILURE);
            break;
    }
...
void
perfmon_logDerivedMetricsIvybridge(PerfmonGroup group, double time,double timeStamp)
{
    int threadId;
    double tmpValue;
    double inverseClock = 1.0 /(double) timer_getCpuClock();
...
static PerfmonGroupHelp ivybridge_group_help[NUM_GROUPS_IVYBRIDGE] = {
