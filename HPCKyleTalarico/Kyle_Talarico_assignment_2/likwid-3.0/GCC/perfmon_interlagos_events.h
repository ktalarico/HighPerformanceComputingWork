...
#define NUM_ARCH_EVENTS_INTERLAGOS 514
...
, {"FPU_PIPE_ASSIGNMENT_PIPE_1",
   "PMC3", 
   0x00,0x02,0,0}
, {"FPU_PIPE_ASSIGNMENT_PIPE_2",
   "PMC3", 
   0x00,0x04,0,0}
, {"FPU_PIPE_ASSIGNMENT_PIPE_3",
   "PMC3", 
   0x00,0x08,0,0}
, {"FPU_PIPE_ASSIGNMENT_DUAL_PIPE_0",
   "PMC3", 
   0x00,0x10,0,0}
, {"FPU_PIPE_ASSIGNMENT_DUAL_PIPE_1",
   "PMC3", 
   0x00,0x20,0,0}
, {"FPU_PIPE_ASSIGNMENT_DUAL_PIPE_2",
   "PMC3", 
   0x00,0x40,0,0}
, {"FPU_PIPE_ASSIGNMENT_DUAL_PIPE_3",
   "PMC3", 
   0x00,0x80,0,0}
, {"FP_SCHEDULER_EMPTY",
   "PMC", 
   0x01,0x00,0,0}
, {"RETIRED_FLOPS_DOUBLE_MULTADD",
   "PMC3", 
   0x03,0x80,0,0}
...
, {"RETIRED_FLOPS_SINGLE_ALL",
   "PMC3", 
   0x03,0x0F,0,0}
, {"MOV_SCALAR_OPT_SSE_MOV",
   "PMC3", 
   0x04,0x00,0,0}
, {"MOV_SCALAR_OPT_SSE_MOV_ELIM",
   "PMC3", 
   0x04,0x01,0,0}
, {"MOV_SCALAR_OPT_OPS_OPT",
   "PMC3", 
   0x04,0x02,0,0}
, {"MOV_SCALAR_OPT_SCALAR_OPS",
   "PMC3", 
   0x04,0x04,0,0}
, {"RETIRED_SERIALIZING_OPS_SSE_BOTTOM",
   "PMC3|PMC4|PMC5", 
   0x05,0x00,0,0}
, {"RETIRED_SERIALIZING_OPS_SSE_CONTROL_MISPRED",
   "PMC3|PMC4|PMC5", 
   0x05,0x01,0,0}
, {"RETIRED_SERIALIZING_OPS_X87_BOTTOM",
   "PMC3|PMC4|PMC5", 
   0x05,0x02,0,0}
, {"RETIRED_SERIALIZING_OPS_X87_CONTROL_MISPRED",
   "PMC3|PMC4|PMC5", 
   0x05,0x04,0,0}
, {"CYCLES_BOTTOM_OP",
   "PMC3|PMC4|PMC5", 
...
, {"PIPELINE_RESTART_PROBE_HIT",
   "PMC", 
   0x22,0x00,0,0}
, {"LOAD_STORE_QUEUE_FULL_LOAD",
   "PMC0|PMC1|PMC2", 
   0x23,0x01,0,0}
, {"LOAD_STORE_QUEUE_FULL_STORE",
   "PMC0|PMC1|PMC2", 
   0x23,0x02,0,0}
, {"LOCKED_OPERATION_CYCLES_NON_SPEC_CACHE_MISS",
   "PMC", 
   0x24,0x08,0,0}
, {"LOCKED_OPERATION_CYCLES_NON_SPEC",
   "PMC", 
   0x24,0x04,0,0}
...
, {"DATA_CACHE_ACCESSES",
   "PMC", 
   0x40,0x00,0,0}
, {"DATA_CACHE_MISSES_STREAMING",
   "PMC", 
   0x41,0x02,0,0}
, {"DATA_CACHE_MISSES_ALL",
   "PMC", 
   0x41,0x01,0,0}
, {"DATA_CACHE_REFILLS_VALID",
   "PMC", 
   0x42,0x01,0,0}
, {"DATA_CACHE_REFILLS_INVALID",
   "PMC", 
   0x42,0x02,0,0}
, {"DATA_CACHE_REFILLS_ERROR",
   "PMC", 
   0x42,0x08,0,0}
, {"DATA_CACHE_REFILLS_ALL",
   "PMC", 
   0x42,0x0F,0,0}
, {"DATA_CACHE_REFILLS_SYSTEM",
   "PMC0|PMC1|PMC2", 
   0x43,0x00,0,0}
, {"UNIFIED_TLB_HIT_4KB_DATA",
   "PMC0|PMC1|PMC2", 
   0x45,0x01,0,0}
, {"UNIFIED_TLB_HIT_2MB_DATA",
   "PMC0|PMC1|PMC2", 
   0x45,0x02,0,0}
, {"UNIFIED_TLB_HIT_1GB_DATA",
   "PMC0|PMC1|PMC2", 
   0x45,0x04,0,0}
, {"UNIFIED_TLB_HIT_4KB_INSTR",
   "PMC0|PMC1|PMC2", 
   0x45,0x10,0,0}
, {"UNIFIED_TLB_HIT_2MB_INSTR",
   "PMC0|PMC1|PMC2", 
   0x45,0x20,0,0}
, {"UNIFIED_TLB_HIT_1GB_INSTR",
   "PMC0|PMC1|PMC2", 
   0x45,0x40,0,0}
, {"UNIFIED_TLB_MISS_4KB_DATA",
   "PMC0|PMC1|PMC2", 
   0x46,0x01,0,0}
, {"UNIFIED_TLB_MISS_2MB_DATA",
   "PMC0|PMC1|PMC2", 
   0x46,0x02,0,0}
, {"UNIFIED_TLB_MISS_1GB_DATA",
   "PMC0|PMC1|PMC2", 
   0x46,0x04,0,0}
, {"UNIFIED_TLB_MISS_4KB_INSTR",
   "PMC0|PMC1|PMC2", 
   0x46,0x10,0,0}
, {"UNIFIED_TLB_MISS_2MB_INSTR",
   "PMC0|PMC1|PMC2", 
   0x46,0x20,0,0}
, {"UNIFIED_TLB_MISS_1GB_INSTR",
   "PMC0|PMC1|PMC2", 
   0x46,0x40,0,0}
, {"MISALIGNED_ACCESS",
   "PMC", 
...
, {"PREFETCH_INSTR_DISPATCHED_NTA",
   "PMC", 
   0x4B,0x04,0,0}
, {"INEFFECTIVE_PREFETCHES_HIT_L1",
   "PMC", 
   0x52,0x00,0,0}
, {"INEFFECTIVE_PREFETCHES_HIT_L2",
   "PMC", 
   0x52,0x08,0,0}
, {"MEMORY_REQUESTS_UC",
   "PMC0|PMC1|PMC2", 
...
, {"RESPONSE_ON_CACHE_REFILLS_OWNED",
   "PMC0|PMC1|PMC2", 
   0x6C,0x08,0,0}
, {"RESPONSE_ON_CACHE_REFILLS_ERROR",
   "PMC0|PMC1|PMC2", 
   0x6C,0x10,0,0}
, {"RESPONSE_ON_CACHE_REFILLS_MODIFIED_UNWRITTEN",
   "PMC0|PMC1|PMC2", 
   0x6C,0x20,0,0}
, {"OCTWORDS_WRITTEN",
   "PMC0|PMC1|PMC2", 
...
, {"CPU_CLOCKS_UNHALTED",
   "PMC0|PMC1|PMC2", 
   0x76,0x00,0,0}
, {"REQUESTS_TO_L2_IC_FILL",
   "PMC0|PMC1|PMC2", 
   0x7D,0x01,0,0}
, {"REQUESTS_TO_L2_DC_FILL",
   "PMC0|PMC1|PMC2", 
   0x7D,0x02,0,0}
, {"REQUESTS_TO_L2_TLB_FILL",
   "PMC0|PMC1|PMC2", 
   0x7D,0x04,0,0}
, {"REQUESTS_TO_L2_NB_PROBE",
   "PMC0|PMC1|PMC2", 
   0x7D,0x08,0,0}
, {"REQUESTS_TO_L2_CANCELED",
   "PMC0|PMC1|PMC2", 
   0x7D,0x10,0,0}
, {"REQUESTS_TO_L2_PREFETCH_REQ",
   "PMC0|PMC1|PMC2", 
   0x7D,0x40,0,0}
, {"L2_CACHE_MISS_IC_FILL",
   "PMC0|PMC1|PMC2", 
   0x7E,0x01,0,0}
, {"L2_CACHE_MISS_DC_FILL",
   "PMC0|PMC1|PMC2", 
   0x7E,0x02,0,0}
, {"L2_CACHE_MISS_TLB_WALK",
   "PMC0|PMC1|PMC2", 
   0x7E,0x04,0,0}
, {"L2_CACHE_MISS_PREFETCH_REQ",
   "PMC0|PMC1|PMC2", 
   0x7E,0x10,0,0}
, {"L2_FILL_WB_FILL",
   "PMC0|PMC1|PMC2", 
...
, {"L2_FILL_WB_WB_CLEAN",
   "PMC0|PMC1|PMC2", 
   0x7F,0x04,0,0}
, {"PAGE_SPLINTERING_GUEST",
   "PMC0|PMC1|PMC2", 
   0x165,0x01,0,0}
, {"PAGE_SPLINTERING_OTHER",
   "PMC0|PMC1|PMC2", 
   0x165,0x02,0,0}
, {"PAGE_SPLINTERING_HOST",
   "PMC0|PMC1|PMC2", 
   0x165,0x04,0,0}
, {"L2_PREFETCHER_TRIGGER_LOAD",
   "PMC0|PMC1|PMC2", 
   0x16C,0x01,0,0}
, {"L2_PREFETCHER_TRIGGER_STORE",
   "PMC0|PMC1|PMC2", 
   0x16C,0x02,0,0}
...
, {"ITLB_L1_MISS_L2_MISS_2MB",
   "PMC0|PMC1|PMC2", 
   0x085,0x02,0,0}
, {"ITLB_L1_MISS_L2_MISS_1GB",
   "PMC0|PMC1|PMC2", 
   0x085,0x04,0,0}
, {"PIPELINE_RESTART_DUE_TO_ISB",
   "PMC0|PMC1|PMC2", 
   0x086,0x00,0,0}
...
, {"INSTRUCTION_CACHE_VICTIMS",
   "PMC0|PMC1|PMC2", 
   0x08B,0x00,0,0}
, {"INSTRUCTION_CACHE_LINES_INVALIDATED_NON_SMC_MISSED",
   "PMC0|PMC1|PMC2", 
   0x08C,0x08,0,0}
, {"INSTRUCTION_CACHE_LINES_INVALIDATED_NON_SMC_HIT",
   "PMC0|PMC1|PMC2", 
   0x08C,0x04,0,0}
, {"INSTRUCTION_CACHE_LINES_INVALIDATED_SMC_MISSED",
   "PMC0|PMC1|PMC2", 
   0x08C,0x02,0,0}
, {"INSTRUCTION_CACHE_LINES_INVALIDATED_SMC_HIT",
   "PMC0|PMC1|PMC2", 
   0x08C,0x01,0,0}
, {"ITLB_RELOADS",
   "PMC0|PMC1|PMC2", 
...
, {"RETIRED_INDIRECT_BRANCHES_MISPRED",
   "PMC", 
   0x0CA,0x00,0,0}
, {"RETIRED_FP_INSTRUCTIONS_X87",
   "PMC", 
   0x0CB,0x01,0,0}
, {"RETIRED_FP_INSTRUCTIONS_MMX",
   "PMC", 
   0x0CB,0x02,0,0}
...
, {"DISPATCH_STALLS",
   "PMC0|PMC1|PMC2", 
   0x0D1,0x00,0,0}
, {"MICROSEQ_STALL_SERIALIZATION",
   "PMC0|PMC1|PMC2", 
   0x0D3,0x00,0,0}
, {"DISPATCH_STALL_INSTRUCTION_RETIRED_Q_FULL",
   "PMC0|PMC1|PMC2", 
   0x0D5,0x00,0,0}
, {"DISPATCH_STALL_INTEGER_SCHED_Q_FULL",
   "PMC0|PMC1|PMC2", 
   0x0D6,0x00,0,0}
, {"DISPATCH_STALL_FP_SCHED_Q_FULL",
   "PMC0|PMC1|PMC2", 
   0x0D7,0x00,0,0}
, {"DISPATCH_STALL_LDQ_FULL",
   "PMC0|PMC1|PMC2", 
   0x0D8,0x00,0,0}
, {"MICROSEQ_STALL_WAITING_ALL_QUIT",
   "PMC0|PMC1|PMC2", 
   0x0D9,0x00,0,0}
, {"FPU_EXCEPTION_TOTAL_MICROFAULTS",
   "PMC", 
   0x0DB,0x01,0,0}
, {"FPU_EXCEPTION_TOTAL_MICROTRAPS",
   "PMC", 
   0x0DB,0x02,0,0}
, {"FPU_EXCEPTION_INT2EXT_FAULTS",
   "PMC", 
   0x0DB,0x04,0,0}
, {"FPU_EXCEPTION_EXT2INT_FAULTS",
   "PMC", 
   0x0DB,0x08,0,0}
, {"FPU_EXCEPTION_BYPASS_FAULTS",
   "PMC", 
   0x0DB,0x10,0,0}
, {"FPU_EXCEPTION_ALL",
   "PMC", 
   0x0DB,0x1F,0,0}
, {"DISPATCH_STALL_STQ_FULL",
   "PMC", 
   0x0D8,0x00,0,0}
, {"UNC_DRAM_ACCESSES_DCT0_PAGE_HIT",
   "UPMC", 
   0x0E0,0x01,0,0}
, {"UNC_DRAM_ACCESSES_DCT0_PAGE_MISS",
   "UPMC", 
   0x0E0,0x02,0,0}
, {"UNC_DRAM_ACCESSES_DCT0_PAGE_CONFLICT",
   "UPMC", 
   0x0E0,0x04,0,0}
, {"UNC_DRAM_ACCESSES_DCT0_ALL",
   "UPMC", 
   0x0E0,0x07,0,0}
, {"UNC_DRAM_ACCESSES_DCT1_PAGE_HIT",
   "UPMC", 
   0x0E0,0x08,0,0}
, {"UNC_DRAM_ACCESSES_DCT1_PAGE_MISS",
   "UPMC", 
   0x0E0,0x10,0,0}
, {"UNC_DRAM_ACCESSES_DCT1_PAGE_CONFLICT",
   "UPMC", 
   0x0E0,0x22,0,0}
, {"UNC_DRAM_ACCESSES_DCT1_ALL",
   "UPMC", 
   0x0E0,0x38,0,0}
, {"UNC_DRAM_ACCESSES_ALL",
   "UPMC", 
   0x0E0,0x3F,0,0}
, {"UNC_DRAM_CONTROLLER_PAGETABLE_OVERFLOW_DCT0",
   "UPMC", 
   0x0E1,0x01,0,0}
, {"UNC_DRAM_CONTROLLER_PAGETABLE_OVERFLOW_DCT1",
   "UPMC", 
   0x0E1,0x02,0,0}
, {"UNC_MEMORY_CONTROLLER_DRAM_SLOTS_MISSING_DCT0",
   "UPMC", 
   0x0E2,0x01,0,0}
, {"UNC_MEMORY_CONTROLLER_DRAM_SLOTS_MISSING_DCT1",
   "UPMC", 
   0x0E2,0x02,0,0}
, {"UNC_MEMORY_CONTROLLER_TURNAROUNDS_DCT0_DIMM",
   "UPMC", 
   0x0E3,0x01,0,0}
, {"UNC_MEMORY_CONTROLLER_TURNAROUNDS_DCT0_READ_TO_WRITE",
   "UPMC", 
   0x0E3,0x02,0,0}
, {"UNC_MEMORY_CONTROLLER_TURNAROUNDS_DCT0_WRITE_TO_READ",
   "UPMC", 
   0x0E3,0x04,0,0}
, {"UNC_MEMORY_CONTROLLER_TURNAROUNDS_DCT1_DIMM",
   "UPMC", 
   0x0E3,0x08,0,0}
, {"UNC_MEMORY_CONTROLLER_TURNAROUNDS_DCT1_READ_TO_WRITE",
   "UPMC", 
   0x0E3,0x10,0,0}
, {"UNC_MEMORY_CONTROLLER_TURNAROUNDS_DCT1_WRITE_TO_READ",
   "UPMC", 
   0x0E3,0x20,0,0}
...
, {"UNC_MEMORY_CONTROLLER_BYPASS_COUNTER_SATURATION_MEM_MED",
   "UPMC", 
   0x0E4,0x02,0,0}
, {"UNC_MEMORY_CONTROLLER_BYPASS_COUNTER_SATURATION_DCT0_DCQ",
   "UPMC", 
   0x0E4,0x04,0,0}
, {"UNC_MEMORY_CONTROLLER_BYPASS_COUNTER_SATURATION_DCT1_DCQ",
   "UPMC", 
   0x0E4,0x08,0,0}
...
, {"UNC_PROBE_RESPONSES_UPSTREAM_REQUESTS_UPSTREAM_NON_ISOC_WRITES",
   "UPMC", 
   0x0EC,0x80,0,0}
, {"UNC_GART_EVENTS_APERTURE_HIT_CPU",
   "UPMC", 
   0x0EE,0x01,0,0}
, {"UNC_GART_EVENTS_APERTURE_HIT_IO",
   "UPMC", 
   0x0EE,0x02,0,0}
, {"UNC_GART_EVENTS_MISS",
   "UPMC", 
   0x0EE,0x04,0,0}
, {"UNC_GART_EVENTS_REQUEST_WALK",
   "UPMC", 
   0x0EE,0x08,0,0}
, {"UNC_GART_EVENTS_MULTIPLE_WALK",
   "UPMC", 
   0x0EE,0x80,0,0}
, {"UNC_LINK_TRANSMIT_BW_L0_USE",
   "UPMC", 
   0x0F6,0x17,0,0}
, {"UNC_LINK_TRANSMIT_BW_L0_NOP",
   "UPMC", 
   0x0F6,0x08,0,0}
, {"UNC_LINK_TRANSMIT_BW_L1_USE",
   "UPMC", 
   0x0F7,0x17,0,0}
, {"UNC_LINK_TRANSMIT_BW_L1_NOP",
   "UPMC", 
   0x0F7,0x08,0,0}
, {"UNC_LINK_TRANSMIT_BW_L2_USE",
   "UPMC", 
   0x0F8,0x17,0,0}
, {"UNC_LINK_TRANSMIT_BW_L2_NOP",
   "UPMC", 
   0x0F8,0x08,0,0}
, {"UNC_LINK_TRANSMIT_BW_L3_USE",
   "UPMC", 
   0x1F9,0x17,0,0}
, {"UNC_LINK_TRANSMIT_BW_L3_NOP",
   "UPMC", 
   0x1F9,0x08,0,0}
...
, {"UNC_MEMORY_CONTROLLER_REQUESTS_READ_WHILE_WRITE",
   "UPMC", 
   0x1F0,0x80,0,0}
, {"UNC_READ_REQ_TO_L3_CORE_0",
   "UPMC", 
   0x4E0,0x07,0,0}
, {"UNC_READ_REQ_TO_L3_CORE_1",
   "UPMC", 
   0x4E0,0x17,0,0}
, {"UNC_READ_REQ_TO_L3_CORE_2",
   "UPMC", 
   0x4E0,0x27,0,0}
, {"UNC_READ_REQ_TO_L3_CORE_3",
   "UPMC", 
   0x4E0,0x37,0,0}
, {"UNC_READ_REQ_TO_L3_CORE_4",
   "UPMC", 
   0x4E0,0x47,0,0}
, {"UNC_READ_REQ_TO_L3_CORE_5",
   "UPMC", 
   0x4E0,0x57,0,0}
, {"UNC_READ_REQ_TO_L3_CORE_6",
   "UPMC", 
   0x4E0,0x67,0,0}
, {"UNC_READ_REQ_TO_L3_CORE_7",
   "UPMC", 
   0x4E0,0x77,0,0}
, {"UNC_READ_REQ_TO_L3_ALL",
   "UPMC", 
   0x4E0,0xF7,0,0}
, {"UNC_READ_REQ_TO_L3_CORE_0_PREF",
   "UPMC", 
   0x4E0,0x0F,0,0}
, {"UNC_READ_REQ_TO_L3_CORE_1_PREF",
   "UPMC", 
   0x4E0,0x1F,0,0}
, {"UNC_READ_REQ_TO_L3_CORE_2_PREF",
   "UPMC", 
   0x4E0,0x2F,0,0}
, {"UNC_READ_REQ_TO_L3_CORE_3_PREF",
   "UPMC", 
   0x4E0,0x3F,0,0}
, {"UNC_READ_REQ_TO_L3_CORE_4_PREF",
   "UPMC", 
   0x4E0,0x4F,0,0}
, {"UNC_READ_REQ_TO_L3_CORE_5_PREF",
   "UPMC", 
   0x4E0,0x5F,0,0}
, {"UNC_READ_REQ_TO_L3_CORE_6_PREF",
   "UPMC", 
   0x4E0,0x6F,0,0}
, {"UNC_READ_REQ_TO_L3_CORE_7_PREF",
   "UPMC", 
   0x4E0,0x7F,0,0}
, {"UNC_READ_REQ_TO_L3_ALL_PREF",
   "UPMC", 
   0x4E0,0xFF,0,0}
, {"UNC_L3_CACHE_MISS_CORE_0",
   "UPMC", 
   0x4E1,0x07,0,0}
, {"UNC_L3_CACHE_MISS_CORE_1",
   "UPMC", 
   0x4E1,0x17,0,0}
, {"UNC_L3_CACHE_MISS_CORE_2",
   "UPMC", 
   0x4E1,0x27,0,0}
, {"UNC_L3_CACHE_MISS_CORE_3",
   "UPMC", 
   0x4E1,0x37,0,0}
, {"UNC_L3_CACHE_MISS_CORE_4",
   "UPMC", 
   0x4E1,0x47,0,0}
, {"UNC_L3_CACHE_MISS_CORE_5",
   "UPMC", 
   0x4E1,0x57,0,0}
, {"UNC_L3_CACHE_MISS_CORE_6",
   "UPMC", 
   0x4E1,0x67,0,0}
, {"UNC_L3_CACHE_MISS_CORE_7",
   "UPMC", 
   0x4E1,0x77,0,0}
, {"UNC_L3_CACHE_MISS_ALL",
   "UPMC", 
   0x4E1,0xF7,0,0}
, {"UNC_L3_CACHE_MISS_CORE_0_PREF",
   "UPMC", 
   0x4E1,0x0F,0,0}
, {"UNC_L3_CACHE_MISS_CORE_1_PREF",
   "UPMC", 
   0x4E1,0x1F,0,0}
, {"UNC_L3_CACHE_MISS_CORE_2_PREF",
   "UPMC", 
   0x4E1,0x2F,0,0}
, {"UNC_L3_CACHE_MISS_CORE_3_PREF",
   "UPMC", 
   0x4E1,0x3F,0,0}
, {"UNC_L3_CACHE_MISS_CORE_4_PREF",
   "UPMC", 
   0x4E1,0x4F,0,0}
, {"UNC_L3_CACHE_MISS_CORE_5_PREF",
   "UPMC", 
   0x4E1,0x5F,0,0}
, {"UNC_L3_CACHE_MISS_CORE_6_PREF",
   "UPMC", 
   0x4E1,0x6F,0,0}
, {"UNC_L3_CACHE_MISS_CORE_7_PREF",
   "UPMC", 
   0x4E1,0x7F,0,0}
, {"UNC_L3_CACHE_MISS_ALL_PREF",
   "UPMC", 
   0x4E1,0xFF,0,0}
, {"UNC_L3_FILLS_BY_L2_EVICTS_CORE_0_M",
   "UPMC", 
   0x4E2,0x08,0,0}
, {"UNC_L3_FILLS_BY_L2_EVICTS_CORE_1_M",
   "UPMC", 
   0x4E2,0x18,0,0}
, {"UNC_L3_FILLS_BY_L2_EVICTS_CORE_2_M",
   "UPMC", 
   0x4E2,0x28,0,0}
, {"UNC_L3_FILLS_BY_L2_EVICTS_CORE_3_M",
   "UPMC", 
   0x4E2,0x38,0,0}
, {"UNC_L3_FILLS_BY_L2_EVICTS_CORE_4_M",
   "UPMC", 
   0x4E2,0x48,0,0}
, {"UNC_L3_FILLS_BY_L2_EVICTS_CORE_5_M",
   "UPMC", 
   0x4E2,0x58,0,0}
, {"UNC_L3_FILLS_BY_L2_EVICTS_CORE_6_M",
   "UPMC", 
   0x4E2,0x68,0,0}
, {"UNC_L3_FILLS_BY_L2_EVICTS_CORE_7_M",
   "UPMC", 
   0x4E2,0x78,0,0}
, {"UNC_L3_FILLS_BY_L2_EVICTS_ALL_M",
   "UPMC", 
   0x4E2,0xF8,0,0}
, {"UNC_L3_FILLS_BY_L2_EVICTS_CORE_0_O",
   "UPMC", 
   0x4E2,0x04,0,0}
, {"UNC_L3_FILLS_BY_L2_EVICTS_CORE_1_O",
   "UPMC", 
   0x4E2,0x14,0,0}
, {"UNC_L3_FILLS_BY_L2_EVICTS_CORE_2_O",
   "UPMC", 
   0x4E2,0x24,0,0}
, {"UNC_L3_FILLS_BY_L2_EVICTS_CORE_3_O",
   "UPMC", 
   0x4E2,0x34,0,0}
, {"UNC_L3_FILLS_BY_L2_EVICTS_CORE_4_O",
   "UPMC", 
   0x4E2,0x44,0,0}
, {"UNC_L3_FILLS_BY_L2_EVICTS_CORE_5_O",
   "UPMC", 
   0x4E2,0x54,0,0}
, {"UNC_L3_FILLS_BY_L2_EVICTS_CORE_6_O",
   "UPMC", 
   0x4E2,0x64,0,0}
, {"UNC_L3_FILLS_BY_L2_EVICTS_CORE_7_O",
   "UPMC", 
   0x4E2,0x74,0,0}
, {"UNC_L3_FILLS_BY_L2_EVICTS_ALL_O",
   "UPMC", 
   0x4E2,0xF4,0,0}
, {"UNC_L3_FILLS_BY_L2_EVICTS_CORE_0_E",
   "UPMC", 
   0x4E2,0x02,0,0}
, {"UNC_L3_FILLS_BY_L2_EVICTS_CORE_1_E",
   "UPMC", 
   0x4E2,0x12,0,0}
, {"UNC_L3_FILLS_BY_L2_EVICTS_CORE_2_E",
   "UPMC", 
   0x4E2,0x22,0,0}
, {"UNC_L3_FILLS_BY_L2_EVICTS_CORE_3_E",
   "UPMC", 
   0x4E2,0x32,0,0}
, {"UNC_L3_FILLS_BY_L2_EVICTS_CORE_4_E",
   "UPMC", 
   0x4E2,0x42,0,0}
, {"UNC_L3_FILLS_BY_L2_EVICTS_CORE_5_E",
   "UPMC", 
   0x4E2,0x52,0,0}
, {"UNC_L3_FILLS_BY_L2_EVICTS_CORE_6_E",
   "UPMC", 
   0x4E2,0x62,0,0}
, {"UNC_L3_FILLS_BY_L2_EVICTS_CORE_7_E",
   "UPMC", 
   0x4E2,0x72,0,0}
, {"UNC_L3_FILLS_BY_L2_EVICTS_ALL_E",
   "UPMC", 
   0x4E2,0xF2,0,0}
, {"UNC_L3_FILLS_BY_L2_EVICTS_CORE_0_S",
   "UPMC", 
   0x4E2,0x01,0,0}
, {"UNC_L3_FILLS_BY_L2_EVICTS_CORE_1_S",
   "UPMC", 
   0x4E2,0x11,0,0}
, {"UNC_L3_FILLS_BY_L2_EVICTS_CORE_2_S",
   "UPMC", 
   0x4E2,0x21,0,0}
, {"UNC_L3_FILLS_BY_L2_EVICTS_CORE_3_S",
   "UPMC", 
   0x4E2,0x31,0,0}
, {"UNC_L3_FILLS_BY_L2_EVICTS_CORE_4_S",
   "UPMC", 
   0x4E2,0x41,0,0}
, {"UNC_L3_FILLS_BY_L2_EVICTS_CORE_5_S",
   "UPMC", 
   0x4E2,0x51,0,0}
, {"UNC_L3_FILLS_BY_L2_EVICTS_CORE_6_S",
   "UPMC", 
   0x4E2,0x61,0,0}
, {"UNC_L3_FILLS_BY_L2_EVICTS_CORE_7_S",
   "UPMC", 
   0x4E2,0x71,0,0}
, {"UNC_L3_FILLS_BY_L2_EVICTS_ALL_S",
   "UPMC", 
   0x4E2,0xF1,0,0}
, {"UNC_L3_FILLS_BY_L2_EVICTS_CORE_0_MOES",
   "UPMC", 
   0x4E2,0x0F,0,0}
, {"UNC_L3_FILLS_BY_L2_EVICTS_CORE_1_MOES",
   "UPMC", 
   0x4E2,0x1F,0,0}
, {"UNC_L3_FILLS_BY_L2_EVICTS_CORE_2_MOES",
   "UPMC", 
   0x4E2,0x2F,0,0}
, {"UNC_L3_FILLS_BY_L2_EVICTS_CORE_3_MOES",
   "UPMC", 
   0x4E2,0x3F,0,0}
, {"UNC_L3_FILLS_BY_L2_EVICTS_CORE_4_MOES",
   "UPMC", 
   0x4E2,0x4F,0,0}
, {"UNC_L3_FILLS_BY_L2_EVICTS_CORE_5_MOES",
   "UPMC", 
   0x4E2,0x5F,0,0}
, {"UNC_L3_FILLS_BY_L2_EVICTS_CORE_6_MOES",
   "UPMC", 
   0x4E2,0x6F,0,0}
, {"UNC_L3_FILLS_BY_L2_EVICTS_CORE_7_MOES",
   "UPMC", 
   0x4E2,0x7F,0,0}
, {"UNC_L3_FILLS_BY_L2_EVICTS_ALL_MOES",
   "UPMC", 
   0x4E2,0xFF,0,0}
, {"UNC_L3_EVICTS_M",
   "UPMC", 
...
, {"UNC_L3_EVICTS_MOES",
   "UPMC", 
   0x4E3,0x0F,0,0}
, {"UNC_L3_NON_CANCEL_READ_REQUESTS_RDBLK_CORE_0",
   "UPMC", 
   0x4ED,0x01,0,0}
, {"UNC_L3_NON_CANCEL_READ_REQUESTS_RDBLK_CORE_1",
   "UPMC", 
   0x4ED,0x11,0,0}
, {"UNC_L3_NON_CANCEL_READ_REQUESTS_RDBLK_CORE_2",
   "UPMC", 
   0x4ED,0x21,0,0}
, {"UNC_L3_NON_CANCEL_READ_REQUESTS_RDBLK_CORE_3",
   "UPMC", 
   0x4ED,0x31,0,0}
, {"UNC_L3_NON_CANCEL_READ_REQUESTS_RDBLK_CORE_4",
   "UPMC", 
   0x4ED,0x41,0,0}
, {"UNC_L3_NON_CANCEL_READ_REQUESTS_RDBLK_CORE_5",
   "UPMC", 
   0x4ED,0x51,0,0}
, {"UNC_L3_NON_CANCEL_READ_REQUESTS_RDBLK_CORE_6",
   "UPMC", 
   0x4ED,0x61,0,0}
, {"UNC_L3_NON_CANCEL_READ_REQUESTS_RDBLK_CORE_7",
   "UPMC", 
   0x4ED,0x71,0,0}
, {"UNC_L3_NON_CANCEL_READ_REQUESTS_RDBLK_ALL",
   "UPMC", 
   0x4ED,0xF1,0,0}
, {"UNC_L3_NON_CANCEL_READ_REQUESTS_RDBLKS_CORE_0",
   "UPMC", 
   0x4ED,0x02,0,0}
, {"UNC_L3_NON_CANCEL_READ_REQUESTS_RDBLKS_CORE_1",
   "UPMC", 
   0x4ED,0x12,0,0}
, {"UNC_L3_NON_CANCEL_READ_REQUESTS_RDBLKS_CORE_2",
   "UPMC", 
   0x4ED,0x22,0,0}
, {"UNC_L3_NON_CANCEL_READ_REQUESTS_RDBLKS_CORE_3",
   "UPMC", 
   0x4ED,0x32,0,0}
, {"UNC_L3_NON_CANCEL_READ_REQUESTS_RDBLKS_CORE_4",
   "UPMC", 
   0x4ED,0x42,0,0}
, {"UNC_L3_NON_CANCEL_READ_REQUESTS_RDBLKS_CORE_5",
   "UPMC", 
   0x4ED,0x52,0,0}
, {"UNC_L3_NON_CANCEL_READ_REQUESTS_RDBLKS_CORE_6",
   "UPMC", 
   0x4ED,0x62,0,0}
, {"UNC_L3_NON_CANCEL_READ_REQUESTS_RDBLKS_CORE_7",
   "UPMC", 
   0x4ED,0x72,0,0}
, {"UNC_L3_NON_CANCEL_READ_REQUESTS_RDBLKS_ALL",
   "UPMC", 
   0x4ED,0xF2,0,0}
, {"UNC_L3_NON_CANCEL_READ_REQUESTS_RDBLKM_CORE_0",
   "UPMC", 
   0x4ED,0x04,0,0}
, {"UNC_L3_NON_CANCEL_READ_REQUESTS_RDBLKM_CORE_1",
   "UPMC", 
   0x4ED,0x14,0,0}
, {"UNC_L3_NON_CANCEL_READ_REQUESTS_RDBLKM_CORE_2",
   "UPMC", 
   0x4ED,0x24,0,0}
, {"UNC_L3_NON_CANCEL_READ_REQUESTS_RDBLKM_CORE_3",
   "UPMC", 
   0x4ED,0x34,0,0}
, {"UNC_L3_NON_CANCEL_READ_REQUESTS_RDBLKM_CORE_4",
   "UPMC", 
   0x4ED,0x44,0,0}
, {"UNC_L3_NON_CANCEL_READ_REQUESTS_RDBLKM_CORE_5",
   "UPMC", 
   0x4ED,0x54,0,0}
, {"UNC_L3_NON_CANCEL_READ_REQUESTS_RDBLKM_CORE_6",
   "UPMC", 
   0x4ED,0x64,0,0}
, {"UNC_L3_NON_CANCEL_READ_REQUESTS_RDBLKM_CORE_7",
   "UPMC", 
   0x4ED,0x74,0,0}
, {"UNC_L3_NON_CANCEL_READ_REQUESTS_RDBLKM_ALL",
   "UPMC", 
   0x4ED,0xF4,0,0}
, {"UNC_L3_LATENCY_CYCLE_COUNT",
   "UPMC", 
   0x4EF,0x01,0,0}
, {"UNC_L3_LATENCY_REQUEST_COUNT",
   "UPMC", 
   0x4EF,0x02,0,0}
};
