...
static PerfmonGroupMap nehalem_group_map[NUM_GROUPS_NEHALEM] = {
    ...
    {"MEM",MEM,"Main memory bandwidth in MBytes/s","INSTR_RETIRED_ANY:FIXC0,CPU_CLK_UNHALTED_CORE:FIXC1,CPU_CLK_UNHALTED_REF:FIXC2,UNC_QMC_NORMAL_READS_ANY:UPMC0,UNC_QMC_WRITES_FULL_ANY:UPMC1,UNC_QHL_REQUESTS_REMOTE_READS:UPMC2,UNC_QHL_REQUESTS_LOCAL_READS:UPMC3,UNC_QHL_REQUESTS_REMOTE_WRITES:UPMC4"},
