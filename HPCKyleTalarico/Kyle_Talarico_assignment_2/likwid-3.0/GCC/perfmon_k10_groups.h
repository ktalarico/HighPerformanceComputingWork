...
perfmon_printDerivedMetricsK10(PerfmonGroup group)
{
    ...
    switch ( group ) 
    {
        ...
        case FLOPS_DP:
            ...
            bstrListAdd(fc,4,DP Add MFlops/s);

            bstrListAdd(fc,5,DP Mult MFlops/s);
            ...
            for(threadId=0; threadId < perfmon_numThreads; threadId++)
            {
                ...
                tmpValue = 1.0E-06*(perfmon_getResult(threadId,"PMC0")+perfmon_getResult(threadId,"PMC1"))/time;
                if (!isnan(tmpValue))
                {
                    tableData.rows[2].value[threadId] = tmpValue;
                }
        ...
        case FLOPS_SP:
            ...
            bstrListAdd(fc,4,SP Add MFlops/s);

            bstrListAdd(fc,5,SP Mult MFlops/s);
        ...
        case FLOPS_X87:
            ...
            bstrListAdd(fc,4,X87 Add MFlops/s);

            bstrListAdd(fc,5,X87 Mult MFlops/s);

            bstrListAdd(fc,6,X87 Div MFlops/s);
            ...
            for(threadId=0; threadId < perfmon_numThreads; threadId++)
            {
                ...
                tmpValue = perfmon_getResult(threadId,"PMC3")*inverseClock;
                if (!isnan(tmpValue))
                {
                    tableData.rows[1].value[threadId] = tmpValue;
                }
                ...
                tmpValue = 1.0E-06*(perfmon_getResult(threadId,"PMC0")+perfmon_getResult(threadId,"PMC1")+perfmon_getResult(threadId,"PMC2"))/time;
                if (!isnan(tmpValue))
                {
                    tableData.rows[2].value[threadId] = tmpValue;
                }
        ...
        case L2CACHE:
            ...
            for(threadId=0; threadId < perfmon_numThreads; threadId++)
            {
                ...
                tmpValue = (perfmon_getResult(threadId,"PMC1")+perfmon_getResult(threadId,"PMC3"))/perfmon_getResult(threadId,"PMC0");
                if (!isnan(tmpValue))
                {
                    tableData.rows[1].value[threadId] = tmpValue;
                }
                ...
                tmpValue = perfmon_getResult(threadId,"PMC2")/(perfmon_getResult(threadId,"PMC1")+perfmon_getResult(threadId,"PMC3"));
                if (!isnan(tmpValue))
                {
                    tableData.rows[3].value[threadId] = tmpValue;
                }
        ...
        case MEM:
            ...
            bstrListAdd(fc,2,Read data bandwidth [MBytes/s]);

            bstrListAdd(fc,3,Write data bandwidth [MBytes/s]);
            ...
            for(threadId=0; threadId < perfmon_numThreads; threadId++)
            {
                ...
                tmpValue = 1.0E-06*perfmon_getResult(threadId,"PMC1")*8.0/time;
                if (!isnan(tmpValue))
                {
                    tableData.rows[2].value[threadId] = tmpValue;
                }
                ...
                tmpValue = 1.0E-06*(perfmon_getResult(threadId,"PMC2")+perfmon_getResult(threadId,"PMC3"))*64.0/time;
                if (!isnan(tmpValue))
                {
                    tableData.rows[3].value[threadId] = tmpValue;
                }
                ...
                tmpValue = 1.0E-09*(perfmon_getResult(threadId,"PMC2")+perfmon_getResult(threadId,"PMC3"))*64.0;
                if (!isnan(tmpValue))
                {
                    tableData.rows[4].value[threadId] = tmpValue;
                }
        ...
        case NUMA:
            ...
            bstrListAdd(fc,2,Mega requests per second to Node 0);

            bstrListAdd(fc,3,Mega requests per second to Node 1);

            bstrListAdd(fc,4,Mega requests per second to Node 2);

            bstrListAdd(fc,5,Mega requests per second to Node 3);
        ...
        case NUMA2:
            ...
            bstrListAdd(fc,2,Hyper Transport link0 bandwidth (MBytes/s));

            bstrListAdd(fc,3,Hyper Transport link1 bandwidth (MBytes/s));

            bstrListAdd(fc,4,Hyper Transport link2 bandwidth (MBytes/s));

            bstrListAdd(fc,5,Hyper Transport link3 bandwidth (MBytes/s));
            ...
            for(threadId=0; threadId < perfmon_numThreads; threadId++)
            {
                ...
                tmpValue = 1.0E-06*perfmon_getResult(threadId,"PMC0")*4.0/time;
                if (!isnan(tmpValue))
                {
                    tableData.rows[1].value[threadId] = tmpValue;
                }
                ...
                tmpValue = 1.0E-06*perfmon_getResult(threadId,"PMC2")*4.0/time;
                if (!isnan(tmpValue))
                {
                    tableData.rows[3].value[threadId] = tmpValue;
                }
                ...
                tmpValue = 1.0E-06*perfmon_getResult(threadId,"PMC3")*4.0/time;
                if (!isnan(tmpValue))
                {
                    tableData.rows[4].value[threadId] = tmpValue;
                }
